...
arial = ImageFont.truetype("TAMANNA/assets/assets/font2.ttf", 30)
font = ImageFont.truetype("TAMANNA/assets/assets/font.ttf", 30)
title_font = ImageFont.truetype("TAMANNA/assets/assets/font3.ttf", 45)
...
async def get_thumb(videoid):
    ...
    try:
        ...
        play_icons = Image.open("TAMANNA/assets/assets/play_icons.png").resize((580, 62))
