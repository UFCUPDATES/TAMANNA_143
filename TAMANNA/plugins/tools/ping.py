...
from TAMANNA.utils.decorators.language import language
from TAMANNA.utils.inline import supp_markup
from TAMANNA.utils.inline import close_markup
...
async def ping_com(client, message: Message, _):
    PING_IMG_URL = "https://files.catbox.moe/m78dkp.jpg"
    ...
    reply_markup=InlineKeyboardMarkup(
        ...
        [
            ...
            InlineKeyboardButton(
                text="• ᴍᴏʀᴇ •", url=f"https://t.me/UFC_UPDATES",
            )
        ],
        [
            InlineKeyboardButton(
