...
EVAA = [
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://TAMANNA_MUSIC_BOT?startgroup=true"),
    ],
]
...
bg_path = "TAMANNA/assets/SonaINFO.png"
font_path = "TAMANNA/assets/hiroko.ttf"
